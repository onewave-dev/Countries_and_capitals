...
- Перед каждым ходом бот рассылает полный текст вопроса всем участникам: активному игроку сообщение приходит с кнопками ответа, остальные получают тот же текст без клавиатуры.
