...
Для администратора в меню доступен отдельный пункт «[адм.] Тестовая игра» для быстрой проверки кооперативного режима: после выбора континента матч сразу запускается на средней сложности.
