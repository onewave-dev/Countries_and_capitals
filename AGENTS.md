...
- Матч завершается, когда все пары исчерпаны. Бот отправляет итог, включая победителя (Команда игроков или Бот).
...
5. После каждого вопроса бот рассылает итог обоим игрокам и делает паузу 2–3 сек для читаемости.
