...
- К каждой карточке предлагаются **четыре варианта ответа** (правильный и три случайных из выбранного континента).
- Кнопки: варианты ответов, **Показать ответ**, **Пропустить**, **Завершить**.
- По завершении сессии бот выводит список «**неизученных**» (неверных ответов) и предлагает повторить их отдельно.
...
2. Бот показывает карточку с четырьмя вариантами ответа. Можно выбрать вариант, нажать «Показать ответ» или «Пропустить».
