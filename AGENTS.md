...
- При верном ответе сообщение заменяет карточку, а бот дополнительно отправляет случайный факт (≤150 символов) о стране/столице, сгенерированный LLM. Факты кешируются и могут быть расширены в других режимах.
...
│   ├── facts.py                # случайные факты (LLM, кэш)
